...
from seishub.services.sftp import ivfs, pathutils
...
class AdaptFileSystemUserToISFTP:
    ...
    def __init__(self, avatar):
        ...
        # create root dir from package registry
        root = self.filesystem.root
        root.createDirectory('seishub')
        ...
        seishub.createDirectory('quakeml')
        seishub.createDirectory('xseed')
        
        # create just a 10000x dirs
        quakeml = self.filesystem.fetch('/seishub/quakeml')
        for i in range(0,10000):
            quakeml.createDirectory(str(i))
